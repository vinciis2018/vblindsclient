...
export const ArweaveIcon = (props: IconProps) => (
  <Icon viewBox="0 0 31.8 31.8" {...props}>
    <circle fill="transparent" strokeWidth="2.5" stroke="currentColor" cx="15.9" cy="15.9" r="14.7" />
    <path
      fill="currentColor"
